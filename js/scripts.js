...
function change_x()
{
	let col_x=document.getElementById("colorinputcolor_x").value;
	document.markCheck.style.backgroundColor=col_x;
	document.getElementById("colorinputtext_x").value=color;
